        ...
        <div className="container">
          <div className="flex justify-between items-center gap-10 my-10">
            ...
            <div className="flex-1">
              ...
              <h1 className="font-bold text-[36px] mb-4">
                Hướng dẫn setup phòng cực chill dành cho người mới toàn tập
              </h1>
              <PostMeta></PostMeta>
            </div>
          </div>
          <div className="max-w-[700px] my-[80px] mx-auto">
            ...
            <div className="mt-10 mb-20 rounded-[20px] bg-[#F3EDFF]">
              <PostImage
                url="https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80"
                className="w-[200px] h-[200px] flex-shrink-0 rounded-[20px]"
              ></PostImage>
              <div className="flex-1 p-5">
                <h3 className="font-bold text-[20px] mb-[10px]">Evondev</h3>
